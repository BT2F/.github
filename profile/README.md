...
Queosk는 식당에서 웨이팅과 주문 과정에서 발생하는 시간을 줄이기 위해 전자 주문 시스템인 <br>
**키오스크**와 **웨이팅** 서비스를 결합하여 사용자가 식당에 방문하지 않고도 웨이팅 등록을 하고, <br>
본인의 차례가 왔을 때 스마트폰으로 주문을 할 수 있는 서비스를 통해 시간을 효율적으로 활용 할 수 있도록 도와주는 앱입니다.
